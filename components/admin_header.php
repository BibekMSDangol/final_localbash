<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="events.php"><i class="fas fa-building"></i><span>Venues</span></a>
      <a href="users.php"><i class="fas fa-user"></i><span>Users</span></a>
      <a href="admins.php"><i class="fas fa-user-gear"></i><span>Admins</span></a>
      <a href="messages.php"><i class="fas fa-message"></i><span>Feedback messages</span></a>
   </nav>

   <a href="update.php" class="btn">Updare account</a>
   <div class="flex-btn">
