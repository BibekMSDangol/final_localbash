...
if(isset($_POST['post'])){
   ...
   if ($image_01_size > 2000000) {
      ...
      $insert_property = $conn->prepare("INSERT INTO `property` (id, user_id, property_name, price, address, description, image_01, image_02, image_03, image_04, image_05) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
      $insert_property->execute([$id, $user_id, $property_name, $price, $address, $description, $rename_image_01, $rename_image_02, $rename_image_03, $rename_image_04, $rename_image_05]);
      move_uploaded_file($image_01_tmp_name, $image_01_folder);
      $success_msg[] = 'Venue posted successfully!';
   }
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      <h3>Venue details</h3>
      <div class="box">
         <p>Venue name <span>*</span></p>
         <input type="text" name="property_name" required maxlength="50" placeholder="Enter Venue Name" class="input">
      </div>
      <div class="box">
         <p>Venue price <span>*</span></p>
         <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="Enter venue price" class="input">
      </div>
      <div class="box">
         <p>Venue address <span>*</span></p>
         <input type="text" name="address" required maxlength="100" placeholder="Enter venue full address" class="input">
      </div>
      <div class="box">
         <p>Description <span>*</span></p>
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="Write about your venue."></textarea>
      </div>
      <div class="box">
      ...
      <input type="submit" value="Post venue" class="btn" name="post">
   </form>
