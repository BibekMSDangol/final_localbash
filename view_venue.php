...
<section class="view-property">
   ...
   <h1 class="heading">Venue details</h1>
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <div class="info">
         <p><i class="fa-solid fa-rupee-sign"></i></i><span><?= $fetch_property['price']; ?></span></p>
      ...
      <form action="" method="post" class="flex-btn">
         ...
         ?>
         <button type="submit" name="save" class="save"><i class="far fa-heart"></i><span>Add to Favorite</span></button>
         <?php
            }
         ?>
